...
```
/work/ncbi_datasets$ /share/local/ncbi/ncbi-datasets/bin/datasets summary genome accession GCF_003574215
...
- datasets download
```
/work/ncbi_datasets$ /share/local/ncbi/ncbi-datasets/bin/datasets download genome accession GCF_003574215
...
/work/ncbi_datasets$ unzip ncbi_dataset.zip 
...
/work/ncbi_datasets$ cat ncbi_dataset/data/assembly_data_report.jsonl 
...
```
  - 何も指定しないとncbi_dataset.zipがダウンロードされる。変更するには`--filename string`をつける(例：--filename datasets.GCF_003574215.zip)
